...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2FoYmEyMCIsImEiOiJjbGdoM25sZ2MwNzQ0M2RsZnppMXZ6N2hwIn0.8b6Z3WBnJCaTlYIiJfGrCA';
...
var stripe = Stripe('pk_test_51N0scKGy8WG1wDJ7AWk6pliqafAz1oTgOV07ULIXc4UuWjFzjz7o8Swt6H7ooF4SuLTecN08nT4EZFQDdOMskVJm00Nq5wSant');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    if ((0, _updateSettings.updateSettings)(form, 'data')) location.reload(true); // const name = document.getElementById('name').value;
